...
class ReCAPUDFMaxMinTrailDB:
    ...
    def run_with_max_min_udf(self, min_length: int, max_length: int, starter_node: int) -> Tuple[int, float]:
        c = self.conn
...
def main():
    ...
    print("-" * 50)
    start_node = 76367 # change if needed
    for max_len in range(2, 11):
       recap.run_with_max_min_udf(2, max_len, start_node)
