...
# ============================================================================
# Main DuckDB Class with Max-Min Trail UDF
# ============================================================================
...
def main():
    parser = argparse.ArgumentParser(description='DuckDB Max-Min Trail UDF')
    ...
    # Load data
    print("Running DuckDB Max-Min Trails Query...")
    ...
    for i in range(2, n+1):
        recap.run_with_pure_recap_max_min_trail_udf(2, i, starter_node)
