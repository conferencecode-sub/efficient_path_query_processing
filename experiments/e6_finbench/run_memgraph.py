"""FinBench TCR1/TCR5/TCR8 competitor run: Memgraph. Same schema/query
...
container already held unrelated data from an earlier experiment this
session; `clear_database` wipes it (that data is reproducible from its own
run script any time, per this project's own `--fresh-db` convention).
"""
import csv
import os
import time
