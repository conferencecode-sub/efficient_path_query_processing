"""Shared loader for E6 (LDBC FinBench TCR1/TCR5/TCR8), SF0.1 data generated
this session (see `experiments/datasets/finbench_sf0.1/README.md` for
provenance). Unions FinBench's separate edge tables (transfer, withdraw,
deposit, signIn, personOwnAccount) into one `edges` table with the
...
DATASET_DIR = os.path.join(_HERE, "..", "datasets", "finbench_sf0.1")

START_TIME = 1_500_000_000_000  # covers the full generated range (~1579081158811..1672531183624)
