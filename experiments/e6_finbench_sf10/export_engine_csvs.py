...
to CSV for the graph-DBMS competitor comparison (Neo4j/Memgraph/Kùzu) at
SF10, mirroring `experiments/e6_finbench/export_engine_csvs.py` (SF0.1).
"""
import os
...
OUT_DIR = os.path.join(_HERE, "..", "datasets", "finbench_sf10_engine_ready")
