"""Shared loader for E6/SF10 (LDBC FinBench TCR1/TCR5/TCR8), SF10 data generated
this session (see `experiments/datasets/finbench_sf10/README.md` for
...
SF10's own generated timestamp range (~1584412876953..1672531196874 across
...
DATASET_DIR = os.path.join(_HERE, "..", "datasets", "finbench_sf10")

START_TIME = 1_500_000_000_000  # confirmed still covers SF10's own generated range
