"""E6/SF1 / TCR8: sweeps ReCAP (Stage F, optimized) over increasing
...
vertex re-derived for SF1's own graph.
"""
...
# Re-derived for SF1 via the same methodology as SF0.1 ("loan with the most
# deposit-reachable transfer/withdraw chains at length 2"): joining
# deposit->{transfer,withdraw} and grouping by the loan, against SF1's own
# loaded data -> 2,899 reachable.
START_VERTEX = 302867074940670634
