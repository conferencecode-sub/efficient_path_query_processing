...
# ============================================================================
# Main DuckDB Class with 2-color Trail UDF
# ============================================================================
...
def main():
    parser = argparse.ArgumentParser(description='DuckDB 2-color Trails Query (Inline Version)')
    ...
    n = 6 # max path length to test
    starter_node =  4515 # change if needed
    for i in range(2, n+1):
        duckdbs.run_with_pure_recap_color_trail_udf(2, i, starter_node)
